        ...
        do {
            ...
            switch (Menu) {
                case 0:
                    break;
                case 1: {
                    contas0.imprimir(contas0);
                    TaldoSidoka.imprimirFisica();
                    contas1.imprimir(contas1);
                    PastelãoChina.imprimirJuridica();
                    break;
                }
                case 2: {
                    ...
                    System.out.println("----------------------------------");
                    System.out.println("Novo Saldo "+TaldoSidoka.nome+":"+contas0.getSaldo());
                    System.out.println("Novo Saldo "+PastelãoChina.nome+":"+contas1.getSaldo());
                    System.out.println("----------------------------------");
                    break;
                }
                case 3: {
